...
namespace Unity.Geospatial.Streaming.UnityTerrain
{
    ...
    /// </summary>
    public class UnityTerrainUriLoader :
        UriLoader
    {
        /// <inheritdoc cref="UriLoader.SupportedFileTypes"/>
        private static readonly FileType[] k_SupportedFileTypes = { FileType.UnityTerrain };
        ...
        /// </summary>
        private readonly UnityTerrainStreamer m_Streamer = new UnityTerrainStreamer();
        ...
        public UnityTerrainUriLoader(ILoaderActions loaderActions, UGDataSourceID dataSource, UGLighting lighting, float detailMultiplier) :
            base(loaderActions)
        {
        ...
        public override async Task<InstanceID> LoadAsync(NodeId nodeId, UriNodeContent content, double4x4 transform)
        {
            ...
            UnityTerrainStreamer.TerrainTile meshTile;
            MeshID meshId;
        ...
        private void Load(byte[] terrainData, RevertingCommandStack commandStack, out MeshID meshId, out UnityTerrainStreamer.TerrainTile tile)
        {
        ...
        private static double4x4 UpdateTransform(double4x4 transform, UnityTerrainStreamer.TerrainTile tile)
        {
            //
