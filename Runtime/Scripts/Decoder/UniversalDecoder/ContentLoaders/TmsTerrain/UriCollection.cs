...
{
    /// <summary>
    /// <see cref="IUriCollection"/> to use when loading TMS (Terrain Management System) Terrain datasets.
    /// </summary>
        ...
        IEquatable<UriCollection>
    {
        ...
        /// <summary>
        /// Constructor with all the elements needed to construct the URIs based on the TmsTerrain template.
        /// </summary>
        ...
        /// </summary>
        /// <param name="other">Other collection to compare with.</param>
        /// <returns>
        /// <see langword="true"/> if both objects point to the same uris;
        /// <see langword="false"/> otherwise.
        /// </returns>
        ...
        /// </summary>
        /// <returns>Enumerates the <see href="https://docs.microsoft.com/en-us/dotnet/api/system.uri">Uri</see> part of this instance.</returns>
        ...
        /// Returns an enumerator that iterates through the Uri collection.
        /// </summary>
        /// <returns>A <see href="https://docs.microsoft.com/en-us/dotnet/api/system.uri">Uri</see> enumerator.</returns>
