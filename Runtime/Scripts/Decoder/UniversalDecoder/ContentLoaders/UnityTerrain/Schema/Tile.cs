...
{
    /// <summary>
    /// Represent a single tile part of a Unity Terrain dataset. This contains all the information needed
        ...
        ILeaf
    {
        ...
        /// of this dataset.</param>
        /// <param name="limits">Layout information on how to divide the tile.</param>
        /// <param name="terrain">Decoded Unity Terrain file.</param>
        public Tile(int level, uint column, uint row, ContentSchema content, LimitsSchema limits, UnityTerrainStreamer.TerrainTile terrain)
        {
            Assert.IsNotNull(content, "Content is null.");
            Assert.IsNotNull(limits, "Limits is null.");
        ...
        public void Update(UnityTerrainStreamer.TerrainTile terrain)
        {
            GeometricError = terrain.GeometricError;
            Extent = terrain.Extent;
            MinElevation = terrain.MinElevation;
