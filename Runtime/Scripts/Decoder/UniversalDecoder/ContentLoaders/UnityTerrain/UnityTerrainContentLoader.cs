...
{
    public class UnityTerrainContentLoader :
        HierarchyContentLoader<Tile, UriCollection>
    {
        ...
        /// </param>
        public UnityTerrainContentLoader(INodeContentManager contentManager, ContentType contentType, bool createHierarchyOnDemand = true) :
        ...
        /// <see langword="false"/> to create all the nodes when <see cref="HierarchyContentLoader{TLeaf,TUri}.LoadNodeAsync(NodeId, NodeContent)"/> is executed for a <see cref="HierarchyContentLoader{TLeaf,TUri}.RootContent"/> instance.
        /// </param>
        public UnityTerrainContentLoader(INodeContentManager contentManager, ContentType contentType, double4x4 adjustmentMatrix, bool createHierarchyOnDemand = true) :
